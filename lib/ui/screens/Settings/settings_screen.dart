                        ...
                        child: Material(
                          ...
                          child: ListTile(
                            onTap: () {
                              launchUrl(
                                Uri.parse(
                                  'https://github.com/rajbhar-rohit/Spekify-Music/releases/latest',
                                ),
                ...
                children: [
                  ListTile(
                    ...
                    onTap: () {
                      launchUrl(
                        Uri.parse(
                          'https://github.com/rajbhar-rohit/Spekify-Music',
                        ),
                        mode: LaunchMode.externalApplication,
                      );
                    },
